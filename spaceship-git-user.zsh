...
SPACESHIP_GIT_EMAIL_COLOR="${SPACESHIP_GIT_USER_COLOR="red"}"
SPACESHIP_GIT_EMAIL_PREFIX="${SPACESHIP_GIT_USER_PREFIX="as "}"
SPACESHIP_GIT_EMAIL_SUFFIX="${SPACESHIP_GIT_USER_SUFFIX="$SPACESHIP_PROMPT_DEFAULT_SUFFIX"}"
SPACESHIP_GIT_NAME_COLOR="${SPACESHIP_GIT_USER_COLOR="red"}"
SPACESHIP_GIT_NAME_PREFIX="${SPACESHIP_GIT_USER_PREFIX="as "}"
SPACESHIP_GIT_NAME_SUFFIX="${SPACESHIP_GIT_USER_SUFFIX="$SPACESHIP_PROMPT_DEFAULT_SUFFIX"}"
SPACESHIP_GIT_NAME_SYMBOL="${SPACESHIP_GIT_USER_SYMBOL="👤 "}"
