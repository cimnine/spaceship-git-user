...
SPACESHIP_GIT_EMAIL_INDICATION="${SPACESHIP_GIT_EMAIL_INDICATION="${SPACESHIP_GIT_USER_INDICATION}"}"
SPACESHIP_GIT_EMAIL_PREFIX="${SPACESHIP_GIT_EMAIL_PREFIX="with "}"
SPACESHIP_GIT_EMAIL_SHOW="${SPACESHIP_GIT_EMAIL_SHOW="${SPACESHIP_GIT_USER_SHOW}"}"
...
SPACESHIP_GIT_NAME_INDICATION="${SPACESHIP_GIT_NAME_INDICATION="${SPACESHIP_GIT_USER_INDICATION}"}"
SPACESHIP_GIT_NAME_PREFIX="${SPACESHIP_GIT_NAME_PREFIX="as "}"
SPACESHIP_GIT_NAME_SHOW="${SPACESHIP_GIT_NAME_SHOW="${SPACESHIP_GIT_USER_SHOW}"}"
